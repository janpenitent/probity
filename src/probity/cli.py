...
CONTROLS: list[Control] = [C06Backups(), C17Encryption(), C18Tls(), C19Access(), C20Mfa()]
...
def _run_scan(
    source: str, cloud: str | None, tls: str | None, backup: str | None, fmt: str
) -> int:
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "scan":
        return _run_scan(args.source, args.cloud, args.tls, args.backup, args.format)
    return 2
